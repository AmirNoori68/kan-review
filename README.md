...
| Gaussian + residual | Local | $\sum_i w_i \exp\!\Big(-\big(\tfrac{x-g_i}{\varepsilon}\big)^2\Big) + w_b \rho(x)$ | Yes | Gaussian RBF with SiLU | [Li](https://arxiv.org/abs/2405.06721) , [Code](https://github.com/ZiyaoLi/fast-kan) |
