# kan-review
A structured companion to our [KAN review paper](https://doi.org/10.1016/j.cosrev.2026.100991).
...
| 1957 | [Kolmogorov](https://cs.uwaterloo.ca/~y328yu/classics/Kolmogorov57.pdf) | Full Kolmogorov Superposition Theorem; first general \(n\)-D proof |
| 1958 | Arnol'd | Supplies missing lemmas; completes Kolmogorov’s proof |
| 1962 | [Lorentz](https://doi.org/10.2307/2311185) | Simplified canonical form with a **single outer function** |
| 1965 | [Sprecher](https://www.researchgate.net/profile/David-Sprecher-2/publication/243075889_On_the_Structure_of_Continuous_Functions_of_Several_Variables/links/56e1858808aec09a8bc07e09/On-the-Structure-of-Continuous-Functions-of-Several-Variables.pdf) | First **single universal inner function** |
| 1967 | [Fridman](https://scholar.google.com/scholar_lookup?title=Improvement%20in%20the%20smoothness%20of%20functions%20in%20the%20Kolmogorov%20superposition%20theorem&publication_year=1967&author=B.L%20Fridman) | Shows universal inner functions can be taken **Lipschitz-1** |
| 1980 | [de Figueiredo](https://www.semanticscholar.org/paper/41f360c68c2f7feac5875f9b2c2e1f003e445353) | First network-like interpretation; block diagram + learned outer function (Chebyshev basis) |
| 1987 | [Hecht–Nielsen](https://cs.uwaterloo.ca/~y328yu/classics/Hecht-Nielsen.pdf) | First explicit **neural mapping theorem** based on KST |
| 1989 | [Girosi–Poggio](https://doi.org/10.1162/neco.1989.1.4.465) | First rigorous critique: inner functions must be non-smooth; outer functions non-parametric |
...
| [.../Gaussian-KAN](https://github.com/AmirNoori68/Gaussian-KAN) | Pure Gaussian RBF-KAN implementation, focusing on Gaussian basis functions and scale-parameter effects. |
| [.../PU-GKAN](https://github.com/AmirNoori68/PU-GKAN) | Partition-of-Unity Gaussian KAN implementation, using normalized Gaussian basis functions. |
...
| Gaussian + residual | Local | $\sum_i w_i \exp\!\Big(-\big(\tfrac{x-g_i}{\varepsilon}\big)^2\Big) + w_b \rho(x)$ | Yes | Gaussian RBF with SiLU | [Li](https://arxiv.org/abs/2405.06721) , [Code](https://github.com/ZiyaoLi/fast-kan) & [Lee](https://doi.org/10.1109/JAS.2022.105743)  & [Abueidda](https://doi.org/10.1016/j.cma.2024.117699) , [Code](https://github.com/DiabAbu/Dee) & [Koenig](https://doi.org/10.1016/j.neunet.2025.107883) , [Code](https://github.com/DENG-MIT/LeanKAN) & [Ta](https://arxiv.org/abs/2406.11173) , [Code](https://github.com/hoangthangta/BSRBF_KAN) & [Buhler](https://arxiv.org/abs/2509.10089) & [Zhang](https://arxiv.org/abs/2508.03965)|
| Gaussian | Local | $\sum_i w_i \exp\!\Big(-\big(\tfrac{x-g_i}{\varepsilon}\big)^2\Big)$ | Yes | Pure Gaussian RBF | [Noorizadegan](https://arxiv.org/abs/2604.21174) , [Code](https://github.com/AmirNoori68/Gaussian-KAN) |
| Partition of Unity Gaussian | Local | $\sum_i w_i \dfrac{\exp\!\Big(-\big(\tfrac{x-g_i}{\varepsilon}\big)^2\Big)}{\sum_j \exp\!\Big(-\big(\tfrac{x-g_j}{\varepsilon}\big)^2\Big)}$ | Yes | Partition of Unity Gaussian RBF | [Noorizadegan](https://arxiv.org/abs/2604.23599) , [Code](https://github.com/AmirNoori68/PU-GKAN) |
